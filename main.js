...
//
array_1=['airplane','rain','alarm clock','apple','octagon','bicycle'];
...
function draw(){
   ...
   if(array_1=['airplane','alarm clock','apple','octagon','bicycle','rain']){
    timer_counter2= timer_counter++;
    document.getElementById('timer').innerHTML="TIMER: "+timer_counter2;
   }

   if(timer_counter2 >= 500){
    array_1=['airplane','alarm clock','apple','octagon','bicycle','rain'];
    random_no = Math.floor((Math.random()*array_1.length)+1);
    Element_of_array = array_1[random_no];
    console.log(Element_of_array);
    document.getElementById("draw_sketch").innerHTML="Sketch to be drawn is a "+(Element_of_array);
...
function gotResults(error, results){
    if(error){
        ...
        console.log(results);
        document.getElementById('sketch').innerHTML= "Object: "+ results[0].label;
    ...
    if(results[0].label== Element_of_array){
        score_count2= score_count++;  
        document.getElementById('score').innerHTML="SCORE: "+score_count2;
     }
